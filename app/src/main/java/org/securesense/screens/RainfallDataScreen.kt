...
val rainfallHourlyData = listOf(
    RainfallHourData("9AM",  "☀️", "10%"),
    RainfallHourData("10AM", "☀️", "15%"),
    RainfallHourData("11AM", "☀️", "20%"),
    RainfallHourData("12PM", "☁️", "35%"),
    RainfallHourData("1PM",  "☁️", "45%"),
    RainfallHourData("2PM",  "🌧️", "60%"),
    RainfallHourData("3PM",  "🌧️", "70%"),
    RainfallHourData("4PM",  "☁️", "50%"),
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Box(
                        ...
                        Text("📈  Chart goes here", fontSize = 14.sp,
                            color = ChartBlue, fontWeight = FontWeight.Medium)
                    }
