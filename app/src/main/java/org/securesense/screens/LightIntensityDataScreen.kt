...
data class LightHourData(val hour: String, val icon: String, val lux: String)

val lightHourlyData = listOf(
    LightHourData("9AM",  "☀️", "200lx"), LightHourData("10AM", "☀️", "350lx"),
    LightHourData("11AM", "🌤️", "520lx"), LightHourData("12PM", "☀️", "700lx"),
    LightHourData("1PM",  "☀️", "820lx"), LightHourData("2PM",  "🌤️", "750lx"),
    LightHourData("3PM",  "☁️", "600lx"), LightHourData("4PM",  "☁️", "400lx"),
...
fun LightIntensityDataScreen(
    ...
    Column(
        ...
        Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.fillMaxWidth()) {
            ...
            Text(text = "Light Intensity", fontSize = 24.sp, fontWeight = FontWeight.ExtraBold, color = TextDark, modifier = Modifier.weight(1f), textAlign = TextAlign.Center)
        ...
        Card(modifier = Modifier.fillMaxWidth(), shape = RoundedCornerShape(24.dp), colors = CardDefaults.cardColors(containerColor = CardWhite), elevation = CardDefaults.cardElevation(0.dp)) {
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Box(modifier = Modifier.fillMaxWidth().height(220.dp).background(Color(0xFFFFFDE7), RoundedCornerShape(12.dp)), contentAlignment = Alignment.Center) {
                    Text("📈  Chart goes here", fontSize = 14.sp, color = ChartYellow, fontWeight = FontWeight.Medium)
                }
                ...
                Row(modifier = Modifier.fillMaxWidth().horizontalScroll(rememberScrollState()), horizontalArrangement = Arrangement.SpaceBetween) {
                    lightHourlyData.forEach { entry ->
                        Text(text = entry.lux, fontSize = 11.sp, color = ChartYellow, fontWeight = FontWeight.SemiBold, textAlign = TextAlign.Center, modifier = Modifier.width(50.dp))
                    }
                }
            }
        }
