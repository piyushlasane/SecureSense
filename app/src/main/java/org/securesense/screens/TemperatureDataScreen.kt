...
data class TemperatureHourData(val hour: String, val icon: String, val tempF: String)

val temperatureHourlyData = listOf(
    TemperatureHourData("9AM",  "☀️", "68°"), TemperatureHourData("10AM", "☀️", "70°"),
    TemperatureHourData("11AM", "☀️", "72°"), TemperatureHourData("12PM", "☁️", "75°"),
    TemperatureHourData("1PM",  "☁️", "76°"), TemperatureHourData("2PM",  "🌧️", "74°"),
    TemperatureHourData("3PM",  "🌧️", "72°"), TemperatureHourData("4PM",  "☁️", "70°"),
...
fun TemperatureDataScreen(
    ...
    Column(
        ...
        Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.fillMaxWidth()) {
            ...
            Text(text = "Temperature Data", fontSize = 24.sp, fontWeight = FontWeight.ExtraBold, color = TextDark, modifier = Modifier.weight(1f), textAlign = TextAlign.Center)
        ...
        Card(modifier = Modifier.fillMaxWidth(), shape = RoundedCornerShape(24.dp), colors = CardDefaults.cardColors(containerColor = CardWhite), elevation = CardDefaults.cardElevation(0.dp)) {
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Row(modifier = Modifier.fillMaxWidth().horizontalScroll(rememberScrollState()), horizontalArrangement = Arrangement.SpaceBetween) {
                    temperatureHourlyData.forEach { entry ->
                        Text(text = entry.tempF, fontSize = 12.sp, color = ChartBlue, fontWeight = FontWeight.SemiBold, textAlign = TextAlign.Center, modifier = Modifier.width(50.dp))
                    }
                }
            }
        }
